        ...
        colourdist exists to solve a narrow, inspectable developer-tooling problem:
        CIE colour-difference metrics (CIE76, CIE94, CIEDE2000) plus sRGB ↔ XYZ ↔ Lab conversions. Pure Python.
        ...
        Topics: ciede2000, color, color-difference, lab, python, zero-dependencies
